...
async function addActivityScheduleItem(actorToken, activityScheduleId, activityScheduleItem) {
    const response = await axios.post(
        `${vigilantHarvestServiceUrl.v0}/activity-schedules/${activityScheduleId}/schedule-items`,
        {
            ...
            startDate: activityScheduleItem.startDate,
            startDateYearOffset: activityScheduleItem.startDateYearOffset,
            endDate: activityScheduleItem.endDate,
            endDateYearOffset: activityScheduleItem.endDateYearOffset,
