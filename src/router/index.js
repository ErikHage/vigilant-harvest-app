...
import ActivitySchedulesPage from "@/components/views/dashboard/admin/ActivitySchedulesPage.vue";
import ActivityScheduleDetailsPage from "@/components/views/dashboard/admin/ActivityScheduleDetailsPage.vue";
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: views.dashboard.children.activitySchedules.path,
                name: views.dashboard.children.activitySchedules.name,
                component: ActivitySchedulesPage,
                meta: {
                    requiresAuthenticated: true,
                },
            },
            {
                path: views.dashboard.children.activitySchedules.details.path,
                name: views.dashboard.children.activitySchedules.details.name,
            ...
            {
                path: views.dashboard.children.years.add.path,
                name: views.dashboard.children.years.add.name,
                component: AddPlantingYearPage,
                meta: {
                    requiresAuthenticated: true,
                },
            },
